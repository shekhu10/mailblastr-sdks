...
Status: publication initiated for all nine packages. See registry results below for completion.
...
Publish v5.2.0 through the tested Release workflow and verify every registry
