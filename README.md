...
**v5.1.0 is published on every registry.** Grab your API key from the [MailBlastr dashboard](https://www.mailblastr.com) → API Keys, and you're one snippet away from the inbox.
...
| [`mailblastr-go`](./mailblastr-go) | Go ≥ 1.22 | `go get github.com/shekhu10/mailblastr-sdks/mailblastr-go/v5` | Go modules |
...
| [`mailblastr-java`](./mailblastr-java) | Java ≥ 11 | `com.mailblastr:mailblastr:5.1.0` | Maven Central |
