...
**v1.0.0 is published on every registry.** Grab your API key from the [MailBlastr dashboard](https://www.mailblastr.com) → API Keys, and you're one snippet away from the inbox.
...
| [`mailblastr-java`](./mailblastr-java) | Java ≥ 11 | `com.mailblastr:mailblastr:1.0.0` | Maven Central |
