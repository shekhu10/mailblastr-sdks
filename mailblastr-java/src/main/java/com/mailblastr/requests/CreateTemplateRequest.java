...
/** Body of {@code POST /templates}. */
public final class CreateTemplateRequest implements JsonPayload {
    private final Map<String, Object> body;

    private CreateTemplateRequest(Map<String, Object> body) { this.body = body; }
    ...
    public static final class Builder {
        ...
        public CreateTemplateRequest build() { return new CreateTemplateRequest(new LinkedHashMap<>(m)); }
    }
}
